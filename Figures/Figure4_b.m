...
for idx = 1:1
    for R = [10,20,30]
        load(datapath+name{idx}+"_r"+int2str(R)+"_result");
        subplot(1,3,1);
...
ylabel('$\epsilon_1$','interpreter','latex', 'LineWidth', alw,'FontSize', 14)
...
lg = legend( 'r=10',...
    'r=20', ...
    'r=30','interpreter','latex','NumColumns',4,'Position',[0.115,0.03,0.8,0.1],'FontSize', fsz);

legend('boxoff');

%print("Numerical-result-SVM-different-para",'-depsc','-tiff');