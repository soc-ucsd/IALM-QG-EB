...
for idx = 1:3
    load(datapath+name{idx}+"_r"+int2str(r)+"_result.mat");
    subplot(1,3,1);
...
lg = legend( 'LASSO-1',...
    'LASSO-2', ...
    'LASSO-3','interpreter','latex','NumColumns',4,'Position',[0.115,0.03,0.8,0.1],'FontSize', fsz);

legend('boxoff');

%print("Numerical-result-LASSO-r5",'-depsc','-tiff');